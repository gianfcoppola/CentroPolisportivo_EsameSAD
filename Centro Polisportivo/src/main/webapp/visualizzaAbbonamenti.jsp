...
<title>Visualizza abbonamenti</title>
<meta charset="UTF-8">
        ...
        <div class="section-center" style="height: 100%;">
          <div class="container" style="height: 100%;">
            <div class="row" style="height: 1000px;" >
              ...
              <p style="margin-left: -60px; width: 1000px; color: aliceblue; font-size: 50px; text-align: center;">Storico abbonamenti</p>
                <table>
			...
			<td><b>Utente</b></td>
			<td><b>Corso</b></td>
			<td><b>Inizio abbonamento</b></td>
			<td><b>Fine abbonamento</b></td>
			<td><b>Prezzo totale</b></td>
		</tr>
                  <%
	List<Abbonamento> listaAbbonamenti= (List<Abbonamento>)session.getAttribute("listaAbbonamenti");
	for (Abbonamento a: listaAbbonamenti) {
	%>
	<tr>
		<td><%=a.getId() %></td>
		<td><%=a.getUtente().getId() %></td>
		<td><%=a.getCorso().getId() %></td>
