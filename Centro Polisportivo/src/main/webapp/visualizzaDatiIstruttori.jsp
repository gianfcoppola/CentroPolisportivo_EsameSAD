      ...
      <div id="booking" class="section" style="margin-left: -40px; height: 100%;">
        <div class="section-center" style="height: 100%;">
          <div class="container" style="height: 100%;">
            <div class="row" style="height: 677px;" >
              <div class="booking-form" style="height: 100%;">
                <div class="row" style="margin-left: 30px;">
               
              <p style="margin-left: -60px; width: 1000px; color: aliceblue; font-size: 50px; text-align: center;">Dati istruttori</p>
                <table>
<tr>
			<td><b>ID</b></td>
			<td><b>Nome</b></td>
		...
		<tr>
			...
			<td><%=i.getCognome() %></td>
			<td><%=i.getSport() %></td>
			<td style="width: 230px;"><%=i.getDescrizione() %></td>
			<td><%=i.getDataNascita() %></td>
			<td><%=i.getEmail() %></td>
