...
<%
String dataInizioAbbonamento = (String)session.getAttribute("dataInizioAbbonamento");
String dataFineAbbonamento = (String)session.getAttribute("dataFineAbbonamento");
String corso = (String)session.getAttribute("corsoAbb");
String istruttore = (String)session.getAttribute("istruttoreCorso");
int numeroLezioni = (int)session.getAttribute("numeroLezioniSettimana");
int prezzoAbb = (int)session.getAttribute("prezzoTotaleAbbonamento");
int idUtente = u.getId();
String nomeUtente = u.getNome();
String cognomeUtente = u.getCognome();
%>
        ...
        <div class="section-center" style="height: 100%;">
          <div class="container" style="height: 100%;">
           ...
           <form action="<%=request.getContextPath()%>/GestioneAbbonamentiServlet" method="post">
            ...
            <input type="hidden" id="abb" name="abb" value="conferma">
                <div class="row">
                  <table>
                    <tr><td>Nome: </td><td><%=nomeUtente %></td></tr>
<tr><td>Cognome: </td><td><%=cognomeUtente %></td></tr>
<tr><td>Corso: </td><td><%=corso %> tenuto da <%=istruttore %></td></tr>
<tr><td>Inizio abbonamento: </td><td><%=dataInizioAbbonamento %></td></tr>
<tr><td>Fine abbonamento: </td><td><%=dataFineAbbonamento %></td></tr>
<tr><td>Numero lezioni a settimana: </td><td><%=numeroLezioni %></td></tr>
<tr><td>Prezzo abbonamento: </td><td><%=prezzoAbb %></td></tr>

                  </table>
                  <br>
                  <button class="submit-btn" style="width: 600px">Vai al pagamento</button>
				</div>		
			</form>
          </div>
        </div>
